...
****
Hacer 3D no es nada fácil, debo de admitir que sin la ayuda de su engine el trabajo hubiese sido aún mayor, de hecho lo es. Dominar los conceptos del libro rojo y del libro naranja no es nada fácil. Además de que las bases en C++ deben de estar bien fundamentadas. En el desarrollo del proyecto hubo muchas paredes, quise compilar en codeblocks y hay que configurar todo un ambiente, así que desistí. Quise hacer el blending del Skybox y no se pudo. En parte porque necesitaba hacer pruebas en código que entendiera a mi cabalidad y sigo sin entender muchas cosas del código. El semestre pasado, de que llevé Computación Gráfica con Arturo Perez de la Cruz no pude sobrellevar la presión de dos proyectos al mismo tiempo así que decidí pasar con Valencia y reprobar teoría con Arturo. 

Esas decisiones, los fracasos enseñan. El gran fracaso de mi semestre pasado es que no sabía modelar, me dí cuenta que es un tiempo considerable el que se le tiene que asignar para modelar, animar y texturizar. Puse manos a la obra y el intersemestre metí un curso de Blender. Así que éste semestre decidí darle muuy duro a esa parte, fue por eso que al código no le pegue. Preferí especializarme en un área y llevamos así el proyecto desde un inicio. Así se lo propuse a Rodrigo y el aceptó, así que es por ello el resultado que tenemos, cada uno se especializó. Como dice el dicho zapatero a tus zapatos, los resultados a mi muy humilde manera de ver la verdad me dejaron ... no se, fué un desarrollo muy distinto a que si lo hubiese hecho sólo. Me siento muy bien con el producto mínimo viable y es por eso que quisiera seguir trabajando en él. 
